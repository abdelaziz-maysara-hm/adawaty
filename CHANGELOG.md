...
- Added browser-local `csv-to-excel-converter` and `excel-to-csv-converter` using SheetJS (XLSX/XLS ↔ CSV).
- Completed the Excel ↔ CSV leg of the conversion matrix; processing stays fully on-device.
- Updated ROADMAP conversion matrix status for documents/data.
...
## Sprint 6 and earlier batches

See git history for Sprints 5–6 batch notes.
