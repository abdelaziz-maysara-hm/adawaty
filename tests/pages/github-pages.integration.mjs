...
assert.match(indexHtml, /Sprint 7 · Batch 22/);
assert.match(indexHtml, /\.\/src\/css\/main\.css/);
assert.match(indexHtml, /\.\/src\/pages\/home\.js\?v=s7b22/);
...
assert.match(catalogueHtml, /catalogue-page\.js\?v=s7b22/);
...
assert.match(bmiToolHtml, /tool-page\.js\?v=s7b22/);
assert.match(bmiToolHtml, /http-equiv="Cache-Control" content="no-cache"/);

console.log('Sprint 7 Batch 22 catalogue navigation verification passed.');
