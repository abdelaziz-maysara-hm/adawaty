...
assert.match(indexHtml, /Sprint 7 · Batch 16/);
assert.match(indexHtml, /\.\/src\/css\/main\.css/);
assert.match(indexHtml, /\.\/src\/pages\/home\.js\?v=s7b16/);
...
assert.match(catalogueHtml, /catalogue-page\.js\?v=s7b16/);
...
assert.match(bmiToolHtml, /tool-page\.js\?v=s7b16/);
assert.match(bmiToolHtml, /http-equiv="Cache-Control" content="no-cache"/);

console.log('Sprint 7 Batch 16 catalogue navigation verification passed.');
