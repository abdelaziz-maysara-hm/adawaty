...
assert.match(indexHtml, /Sprint 7 · Batch 18/);
assert.match(indexHtml, /\.\/src\/css\/main\.css/);
assert.match(indexHtml, /\.\/src\/pages\/home\.js\?v=s7b18/);
...
assert.match(catalogueHtml, /catalogue-page\.js\?v=s7b18/);
...
assert.match(bmiToolHtml, /tool-page\.js\?v=s7b18/);
assert.match(bmiToolHtml, /http-equiv="Cache-Control" content="no-cache"/);

console.log('Sprint 7 Batch 18 catalogue navigation verification passed.');
