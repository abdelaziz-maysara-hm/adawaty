...
assert.match(indexHtml, /Sprint 7 · Batch 14/);
assert.match(indexHtml, /\.\/src\/css\/main\.css/);
assert.match(indexHtml, /\.\/src\/pages\/home\.js\?v=s7b14/);
...
assert.match(catalogueHtml, /catalogue-page\.js\?v=s7b14/);
...
assert.match(bmiToolHtml, /tool-page\.js\?v=s7b14/);
assert.match(bmiToolHtml, /http-equiv="Cache-Control" content="no-cache"/);

console.log('Sprint 7 Batch 14 catalogue navigation verification passed.');
